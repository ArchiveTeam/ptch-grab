...
More information about the archiving project can be found on the ArchiveTeam wiki: http://archiveteam.org/index.php?title=Ptch
...
### For Debian/Ubuntu:
    ...
    pip install seesaw
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/ptch-grab.git; cd ptch-grab; ./get-wget-lua.sh" archiveteam
    screen su -c "cd /home/archiveteam/ptch-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, ptch-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/ptch-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
